document.addEventListener('DOMContentLoaded', function() {
    ...
    const colorImages = {
        'Blanco': 'img/sudaderahombre-blanca.jpg',
        'Negro': 'img/sudaderahombre-negra.jpg',
        'Azul Marino': 'img/sudaderahombre.webp'
    };
    ...
    //este codigo es para el selector de talla, para cambiar de color al seleccionar//
